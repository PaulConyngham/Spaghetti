...
export function ModalDataForm() {
  ...
  const closeModal = (e) => {
    console.log('lah ini apa', e.target.id)
  ...
  return !formModal && formModal !== 0 ? '':(
    <div
      ...
      tabIndex="-1"
      aria-hidden="false"
      className="fixed top-0 left-0 right-0 z-50 w-screen p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-screen max-h-full flex justify-center items-center bg-slate-900/70"
      onClick={closeModal}
    >
        <div className="relative w-full max-w-2xl max-h-full">
            ...
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div className="p-6 space-y-2 text-left">
                  <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400 mb-4 text-center">
                    Some notes here.
                  </p>
                  <div>
